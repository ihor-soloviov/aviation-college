        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
              Авіаційна освіта, <br /> яка не зупиняється
            </h2>
            <p className="text-muted-foreground">
              Попри часткове знищення інфраструктури внаслідок ракетного удару,
              коледж продовжує підготовку авіаційних фахівців. Ми поєднуємо
              дистанційне навчання з практикою на авіаційно-технічній базі,
              забезпечуючи студентам гідну освіту навіть у надскладних умовах.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div
                ...
                style={{ background: "#0D8044" }}
              >
                <Image
                  src="/google-class.png"
