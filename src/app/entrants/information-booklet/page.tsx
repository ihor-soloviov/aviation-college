            ...
            <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-100/50 dark:from-blue-950 dark:to-blue-900/50 pb-8">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <CardTitle className="text-2xl md:text-3xl dark:text-white">
                    {booklet.title}
                  </CardTitle>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground dark:text-gray-300 leading-relaxed">
                    Якщо у вас виникли запитання щодо вступу, зверніться до
                    приймальної комісії Криворізького фахового коледжу
                    Національного авіаційного університету. Ми завжди раді
                    допомогти майбутнім студентам!
                  </p>
                </div>
              </div>
            </CardContent>
