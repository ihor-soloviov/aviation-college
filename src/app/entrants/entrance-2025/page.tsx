...
export default function DocumentsPage() {
  ...
  const renderDocumentTree = (items: DocumentItem[], level = 0) => {
    return items.map((item) => {
      ...
      const paddingLeft = level * 16 + 12; // Consistent base padding for all items
      ...
      if (hasPdf) {
        return (
          ...
          >
            ...
            />
            <span className="line-clamp-2 break-words flex-1">{item.title}</span>
          </button>
        );
      }
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="bg-blue-900 text-white px-6 py-4 flex items-center gap-3 flex-shrink-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="font-semibold line-clamp-2 break-words">{selectedTitle}</h3>
