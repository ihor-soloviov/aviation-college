      ...
      <div className="container mx-auto px-4 space-y-12">
        ...
        <div className="flex flex-col items-center space-y-4 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground">
            Запрошуємо учнів 9-тих класів на підготовчі курси для вступу до коледжу
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
          ...
          >
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Тривалість курсів</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  З жовтня по травень (початок червня). Повний курс підготовки до вступу.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          >
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Предмети курсів</h3>
          ...
          >
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Випускні екзамени</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Тестування з можливістю отримати до 10 додаткових балів при вступі.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          >
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Форма навчання</h3>
          ...
          >
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Вартість курсів</h3>
                <div className="space-y-1">
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">3500 грн</p>
                  <p className="text-xs text-muted-foreground">за весь курс навчання</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          >
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Графік занять</h3>
                <div className="flex items-center gap-2 text-sm">
                  <Clock className="h-4 w-4 text-gray-600 dark:text-gray-400" />
                  <span className="font-medium">09:00 - 12:00</span>
                </div>
                <p className="text-xs text-muted-foreground">Кожної суботи протягом курсу</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                ...
                <div className="flex-1 space-y-3">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Як записатися на курси</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        <a href="tel:+380672967175" className="font-semibold text-blue-600 hover:underline">
                          067-296-71-75
                        </a>
                      </p>
                    </div>
                    <div className="space-y-2">
                      ...
                      <a
                        href="https://docs.google.com/forms/d/e/1FAIpQLSf70UNr0UeYDBLI2z4HvXfHh090fv3yQiQgr-Nz76bC9T3os6w/viewform?usp=dialog"
                        target="_blank"
          ...
          >
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Контактна інформація</h3>
                  <p className="text-sm text-muted-foreground">
